...
def generate_hashtags(topic):
    ...
    Author: Paridhi chahal (2301730186)
    """
    import random
...
def main():
    ...
    Developed by: Vaibhav Bhardwaj (2301730192)
    """
    
    # Header
    st.markdown('<h1 class="main-header">🚀 Social Media Content Generator</h1>', 
                unsafe_allow_html=True)
    st.markdown('<p class="sub-header">Powered by AI | Developed by Paridhi chahal (2301730186)</p>', 
                unsafe_allow_html=True)
    
    # Sidebar
    with st.sidebar:
        st.header("📋 Project Information")
        st.write("**Developer:** Vaibhav Bhardwaj")
        st.write("**Roll No:** 2301730192")
        ...
        if topic:
            with st.spinner("🤖 AI is generating your content... Please wait."):
                try:
                    ...
                    # Footer
                    st.divider()
                    st.caption("Content generated by AI | Created by Vaibhav Bhardwaj (2301730192)")
