...
# Created by: Vaibhav Bhardwaj (2301730192)
...
def main():
    ...
    Developed by: Paridhi chahal (2301730186)
    """
    print("\n" + "="*60)
    print("   SOCIAL MEDIA CONTENT GENERATOR")
    print("   Developed by:Paridhi chahal")
    print("   Roll No: 2301730186")
    print("="*60 + "\n")
    ...
    print("   Created by: Paridhi chahal (2301730186)")
    print("="*60 + "\n")
